...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-primary-500 text-start text-base font-semibold text-primary-700 bg-primary-50/50 focus:outline-none focus:text-primary-850 focus:bg-primary-100 focus:border-primary-700 transition duration-150 ease-in-out'
